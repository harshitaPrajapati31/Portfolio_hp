                  ...
                  <div className="md:w-1/2 p-8">
                    ...
                    <div className="flex flex-row">
                      <a
                        ...
                        href="https://github.com/hp11111/coindom_crypto"
                        rel="noreferrer"
                      >
                        Code
                        <svg
                      ...
                      <a
                        ...
                        href="https://coindom-crypto-eosin.vercel.app"
                        rel="noreferrer"
                      >
                        Live Demo
                        <svg
                  ...
                  <div className="md:w-1/2 p-8">
                    ...
                    <div className="flex flex-row">
                      <a
                        target="_blank"
                        className="flex flex-row items-center p-2 w-1/2"
                        href="https://github.com/harshitaPrajapati31/react-ecommerce"
                        rel="noreferrer"
                      >
                        Code
                        <svg
                  ...
                  <div className="md:w-1/2 p-8">
                    ...
                    <div className="flex flex-row">
                      <a
                        target="_blank"
                        className="flex flex-row items-center p-2 w-1/2"
                        href="https://github.com/harshitaPrajapati31/VroomVista"
                        rel="noreferrer"
                      >
                        Code
                        <svg
