      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-8">
        ...
        >
          ...
          <div className="flex items-center my-6">
            ...
            <h3 className="font-medium text-primary">Harshita Prajapati</h3>
          </div>
          
          <div className="flex items-center my-6">
            <MdEmail className="text-3xl mr-8 hover:text-primary cursor-pointer duration-300"></MdEmail>
            <h3 className="font-medium text-primary">harshitap559@gmail.com</h3>
          </div>
          <div className="flex items-center my-6">
          ...
          <div className="mt-8 flex items-center">
            ...
            <a
              href="https://linkedin.com/in/harshita-prajapati31"
              target="blank"
            ...
            <a
              href="https://www.github.com/hp11111"
              target="blank"
              className="text-3xl text-neutral hover:text-primary hover:-translate-y-1.5 shadow-lg mx-1 duration-300"
            >
