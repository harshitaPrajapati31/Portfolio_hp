...
import image1 from "../../../assets/mine.jpeg";
    ...
    <div className="parent min-h-[100vh] flex flex-col-reverse lg:flex-row items-center justify-between relative ">
      ...
      >
        ...
        <div className="flex items-center translate-y-[-60%] sm:translate-y-[-0%]">
          <a
            href="https://drive.google.com/file/d/1DUlrQ7fD4bbuDFtMEmF0b9LqbnOuDfOx/view?usp=drivesdk"
            target="blank"
          >
      ...
      >
        ...
        <img src={image1} alt="myimage" height="60%" width="50%" className="ml-20 bg-opacity-90 backdrop-blur-lg shadow-2xl  hover:shadow-primary duration-300 cursor-pointer rounded-full"></img>
      </motion.div>
    </div>
  );
};
